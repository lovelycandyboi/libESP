...
public:
    ...
    const byte constantMatrix[4][4] = {
        {0x02,0x03,0x01,0x01},
        {0x01,0x02,0x03,0x01},
        {0x01,0x01,0x02,0x03},
        {0x03,0x01,0x01,0x02},
    };
    const byte inverseConstantMatrix[4][4] = {
        {0x0E,0x0B,0x0D,0x09},
        {0x09,0x0E,0x0B,0x0D},
        {0x0D,0x09,0x0E,0x0B},
        {0x0B,0x0D,0x09,0x0E},
    ...
    void inverse_sub_byte(byte(*plainText)[4]);

    void shift_row(byte(*cipherText)[4]);
    void inverse_shift_row(byte(*plainText)[4]);

    void mix_columns(byte(*cipherText)[4]);
    void inverse_mix_columns(byte(*plainText)[4]);
